...
// in simulator we redefine to format for ikanago Developer console
...
{\
	NSString * exceptionName = [@"org.ikanago." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ikanago";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIikanagoNativeItemNone = -1, 
	UIikanagoNativeItemSpinner = -2,
	UIikanagoNativeItemProgressBar = -3,
	
	UIikanagoNativeItemSlider = -4,
	UIikanagoNativeItemSwitch = -5,
	UIikanagoNativeItemMultiButton = -6,
	UIikanagoNativeItemSegmented = -7,
	
	UIikanagoNativeItemTextView = -8,
	UIikanagoNativeItemTextField = -9,
	UIikanagoNativeItemSearchBar = -10,
	
	UIikanagoNativeItemPicker = -11,
	UIikanagoNativeItemDatePicker = -12,
	
	UIikanagoNativeItemInfoLight = -13,
	UIikanagoNativeItemInfoDark = -14,
	
	UIikanagoNativeItemDisclosure = -15,
	
	UIikanagoNativeItemContactAdd = -16
};
